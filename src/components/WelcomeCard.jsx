...
export default function WelcomeCard({ image, icon, title, text }) {
  return (
    <div className="relative w-[90%] md:w-[300px] h-[300px] overflow-hidden group">
      <Image src={image} alt={title} width={300} height={300} className="object-cover w-full h-full transition duration-300 group-hover:scale-110" />
